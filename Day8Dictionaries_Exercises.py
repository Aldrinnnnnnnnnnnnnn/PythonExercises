...
dog = {"name": "Heidi", "color": "Mahogani", "breed": "Belgian", "legs": 4, "age": 2}
...
student = {
    ...
    "country": "philippines",
    "city": "San fabian",
    "address": {"street": "Bolasi", "zip_code": 2433},
}
...
empty_dict = {"John": user1, "Tom": user2, "Jordan": user3, "Jerome": user4}
print(
    empty_dict
)  # {'John': 'English', 'Thom': 'Tgalog', 'Jordan': 'Hindi', 'Jerome': 'Ilocano'}
