...
print(
    company.swapcase()
)  # cODING fOR all.Converts all uppercase characters to lowercase and all lowercase characters to uppercase characters
...
)  # =0The index() method works similarly to find(), but it raises a ValueError if the substring is not found.
print(
    company.find("Coding")
)  # =0. If the substring is not found, it returns -1. Since "Coding" is at the beginning of the string, it returns 0.
...
name_acronym = (
    name_split[0][0].upper() + name_split[1][0].upper() + name_split[2][0].upper()
)
