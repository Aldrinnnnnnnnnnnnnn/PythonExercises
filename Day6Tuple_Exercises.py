...
print(siblings)#('Aldrin', 'Jordan', 'Marc', 'Stella', 'Heidi', 'Stella', 'jul', 'pia', 'sofia')
#4.How many siblings do you have?
print(len(siblings))#9
#5.Modify the siblings tuple and add the name of your father and mother and assign it to family_members
family_members = list(siblings)
print(family_members)#['Aldrin', 'Jordan', 'Marc', 'Stella', 'Heidi', 'Stella', 'jul', 'pia', 'sofia']
family_members.append('Jords')
family_members.append('Romy')#['Aldrin', 'Jordan', 'Marc', 'Stella', 'Heidi', 'Stella', 'jul', 'pia', 'sofia', 'Jords', 'Romy']
family_members = tuple(family_members)
print(family_members)#('Aldrin', 'Jordan', 'Marc', 'Stella', 'Heidi', 'Stella', 'jul', 'pia', 'sofia', 'Jords', 'Romy')
#Exercises: Level 2
...
print(food_stuff_lt)#['banana', 'apple', 'orange', 'Broccoli', 'Carrots', 'Capsicum', 'Cattle', 'Pig', 'Fish', 'Goat']
