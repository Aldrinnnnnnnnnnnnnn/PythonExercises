...
stri = str(flo)
print(
    f"The length oy the {text} is {length} and convert to float is {flo} to string is {str}"
)
...
seconds_lived = (
    years_lived * day_per_year * hours_perday * minutes_perminute * seconds_perminute
)
# Print the result
